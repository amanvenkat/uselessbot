...
module.exports.run = async (bot, message, args) => {
    ...
    .addField(`**Links** :`, "[\`Support Server\`](https://discord.gg/zyc9vDuWpD) | [\`Invite Me\`](https://discord.com/oauth2/authorize?client_id=887067763158450216&scope=bot&permissions=3221744704) | [\`Vote For Me\`](https://top.gg/bot/808350130352554004/vote) ")
